...
- [references/error-recovery-strategies.md](references/error-recovery-strategies.md): Recovery patterns for different scenarios
- [references/async-error-handling.md](references/async-error-handling.md): Handling errors in concurrent code
- [assets/error-handling-checklist.md](assets/error-handling-checklist.md): Review checklist for error handling
