...
export default function BookingConfirmationModal({ booking, onClose }) {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      if (!imgData || imgData === 'data:,') throw new Error("Generated canvas is empty");
      ...
      pdf.save(`Al-Baith-Booking-${bookingRef}.pdf`);
      
      if (isMobile) setTimeout(() => alert("Ticket downloaded successfully!"), 300);
    } catch (err) {
