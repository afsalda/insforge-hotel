...
import { LISTING_DATA, getListingDetail } from '@/app/rooms/[roomId]/ListingDetailClient';
...
export default function CheckoutClient({ roomId }) {
    const id = roomId;
                            ...
                            {step === 2 && (
                                <div className="step-content-expanded">
                                    ...
                                    <p className="checkout-policy-text">
                                        ...
                                        <span className="underline" onClick={() => router.push('/cancellation-policy')} style={{ cursor: 'pointer' }}>
                                            Cancellation Policy
                                        </span>.
                                    </p>
                                </div>
