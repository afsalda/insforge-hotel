...
const defaultCardImages = [
  "https://images.unsplash.com/photo-1594744803329-a584af1cae21?w=600&q=80",
  "https://images.unsplash.com/photo-1618331835717-801e976710b2?w=600&q=80",
  "https://images.unsplash.com/photo-1610030469983-98e6f24965ce?w=600&q=80",
  "https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=600&q=80",
  "https://images.unsplash.com/photo-1649123245135-4db6ec9337ec?w=600&q=80",
  "https://images.unsplash.com/photo-1628157588553-5eeea00af15c?w=600&q=80"
];
...
const ScannerCardStream = ({
  ...
  return (
    <div className="relative w-full h-[400px] flex items-center justify-center overflow-hidden bg-transparent">
      <style>{`
      ...
      <div
        className={`scanner-line absolute top-1/2 left-1/2 h-[280px] w-[2px] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-b from-transparent via-[#8b5cf6] to-transparent rounded-full transition-opacity duration-300 z-[20] pointer-events-none animate-scan-pulse ${isScanning ? 'opacity-100' : 'opacity-0'}`}
        ...
        <div ref={cardLineRef} className="flex items-center whitespace-nowrap cursor-grab select-none will-change-transform" style={{ gap: `${cardGap}px` }}>
          {cards.map(card => (
            <div key={card.id} className="card-wrapper relative w-[400px] h-[250px] shrink-0">
              ...
              <div className="card-ascii card absolute top-0 left-0 w-full h-full rounded-[15px] overflow-hidden bg-black z-[1] [clip-path:inset(0_calc(100%-var(--clip-left,0%))_0_0)]">
                <pre className="ascii-content absolute top-0 left-0 w-full h-full text-[rgba(220,210,255,0.6)] font-mono text-[11px] leading-[13px] overflow-hidden whitespace-pre m-0 p-0 text-left align-top box-border animate-glitch" style={{ maskImage: 'linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 30%, rgba(0,0,0,0.6) 50%, rgba(0,0,0,0.4) 80%, rgba(0,0,0,0.2) 100%)', WebkitMaskImage: 'linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 30%, rgba(0,0,0,0.6) 50%, rgba(0,0,0,0.4) 80%, rgba(0,0,0,0.2) 100%)' }}>
                  {card.ascii}
                </pre>
              </div>
            </div>
