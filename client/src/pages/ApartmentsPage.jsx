...
const APARTMENT_DATA = {
    '1bhk': { id: 'apt1', name: '1BHK Apartment', price: '₹3,500 / night', maxGuests: 3, desc: 'Cozy fully furnished 1BHK apartment with complete kitchen and living room.', amenities: ['WiFi', 'Kitchen', 'Living Room', 'AC', 'Parking'], extraBedAvailable: false, img: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600&q=80' },
    '2bhk': { id: 'apt2', name: '2BHK Apartment', price: '₹5,500 / night', maxGuests: 5, desc: 'Spacious 2BHK apartment ideal for families, featuring modern furnishings and great views.', amenities: ['WiFi', 'Kitchen', 'Living Room', 'AC', 'Parking', '2 Baths'], extraBedAvailable: true, img: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=600&q=80' },
    '3bhk': { id: 'apt3', name: '3BHK Apartment', price: '₹8,500 / night', maxGuests: 8, desc: 'Luxury 3BHK penthouse style apartment for large groups with premium amenities.', amenities: ['WiFi', 'Kitchen', 'Living Room', 'AC', 'Parking', '3 Baths', 'Balcony'], extraBedAvailable: true, img: 'https://images.unsplash.com/photo-1560448204-61dc36dc98c8?w=600&q=80' }
};
