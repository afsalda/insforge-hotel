...
export default function ListingDetailPage() {
    ...
    const handleReserve = (e) => {
        ...
        if (!checkOut) {
            newErrors.checkOut = 'Please select a checkout date.';
        }
        ...
        if (checkIn && checkOut) {
            ...
            if (checkIn === checkOut) {
                newErrors.checkOut = 'Check-in and checkout cannot be same.';
            } else if (outDate < inDate) {
                newErrors.checkOut = 'Checkout must be after check-in.';
            }
        }
                            ...
                            <div style={{ 
                                ...
                                <div style={{ 
                                    ...
                                    <div style={{ display: 'flex', borderBottom: '1px solid #DDD' }}>
                                        <div style={{ flex: 1, padding: '12px', borderRight: '1px solid #DDD' }}>
            ...
            <div style={{ 
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                        ...
                        <span style={{ color: '#555555', fontSize: '0.9rem' }}>({listing.reviews} review)</span>
                    </div>
                ...
                <div style={{ marginBottom: '0', paddingBottom: '0' }}>
                    <h2 style={{ fontSize: '1.15rem', fontWeight: 400, color: '#000000', marginBottom: '12px' }}>What We Offer</h2>
                    <div style={{ 
                        display: 'flex', 
                        gap: '10px', 
                        overflowX: 'auto', 
                        ...
                        {listing.amenities.map((a, idx) => (
                            <div key={idx} style={{ 
                                ...
                                <div style={{ color: '#000000' }}>
                                    {cloneElement(a.icon, { size: 28, strokeWidth: 1.5 })}
                                </div>
                                <span style={{ fontSize: '0.8rem', color: '#444444', fontWeight: 500 }}>{a.label}</span>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {showBottomSheet && (
                ...
                >
                    <div 
                        ...
                        style={{ width: '100%', backgroundColor: '#FFFFFF', borderRadius: '24px 24px 0 0', padding: '24px' }}
                    >
                        ...
                        <div style={{ display: 'flex', gap: '12px', marginBottom: '20px' }}>
                            <div style={{ flex: 1 }}>
                                <label style={{ display: 'block', fontSize: '0.8rem', marginBottom: '4px' }}>Check-in</label>
                                <input type="date" value={checkIn} min={toDateStr(new Date())} onChange={e => {setCheckIn(e.target.value); setErrors({})}} style={{ width: '100%', padding: '12px', borderRadius: '12px', border: '1px solid #EEE' }} />
                            </div>
                            <div style={{ flex: 1 }}>
                                <label style={{ display: 'block', fontSize: '14px', marginBottom: '4px' }}>Checkout</label>
                                <input type="date" value={checkOut} min={checkIn} onChange={e => {setCheckOut(e.target.value); setErrors({})}} style={{ width: '100%', padding: '12px', borderRadius: '12px', border: '1px solid #EEE' }} />
                            </div>
                        </div>
                        <button 
                            onClick={handleReserve}
                            style={{ width: '100%', height: '52px', backgroundColor: '#000000', color: '#FFFFFF', border: 'none', borderRadius: '12px', fontWeight: 700 }}
                        >
                            Confirm Booking
                        </button>
                    </div>
